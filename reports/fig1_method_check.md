...
- PDF: `/root/workspace/GLX/icassp/MBRS/paper/figures/fig1_method.pdf`; page size `1173.1104 x 675.1584 pt`; file size `52111 bytes`.
- PNG: `/root/workspace/GLX/icassp/MBRS/paper/figures/fig1_method.png`; raster size `5865 x 3375 px`; embedded DPI `360.0 x 360.0`; file size `735749 bytes`.
