...
# All of these experiments use the corrected patch partition/reduction path.
for variant in patch_mean worst ablation_patch16 ablation_patch64 ablation_topk10 ablation_topk50; do
